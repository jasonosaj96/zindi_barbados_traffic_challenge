...
class ZoneDesigner:
    ...
    def __init__(self, video_path, config_path=None, direction=None):
        ...
        # Define all zone types - 4 zones per camera
        # circulating_left, circulating_right, exit, enter
        self.zone_types = [
            'enter',
            'exit',
            'circulating_left',
        ...
        self.zone_colors = {
            ...
            'circulating_left': (255, 165, 0), # Orange
            'circulating_right': (255, 0, 255) # Magenta
        }
    ...
    def get_zone_color(self, zone_name):
        ...
        if 'enter' in zone_name:
            return self.zone_colors['enter']
        elif 'exit' in zone_name:
            return self.zone_colors['exit']
        elif 'circulating_left' in zone_name:
            return self.zone_colors['circulating_left']
        elif 'circulating_right' in zone_name:
            return self.zone_colors['circulating_right']
        return (128, 128, 128)
    ...
    def save_zones(self, output_path=None):
        ...
        for zone_name, zone_data in self.zones.items():
            ...
            config["zone_descriptions"][zone_name] = f"{zone_data['type']} zone"
    ...
    def run(self):
        ...
        print()
        print("Zone Types:")
        print("  1. enter (Green): Vehicles entering the roundabout")
        print("  2. exit (Red): Vehicles exiting the roundabout")
        print("  3. circulating_left (Orange): Vehicles circulating on left side")
        print("  4. circulating_right (Magenta): Vehicles circulating on right side")
        print()
...
def main():
    ...
    designer = ZoneDesigner(args.video, args.config)
    designer.run()
