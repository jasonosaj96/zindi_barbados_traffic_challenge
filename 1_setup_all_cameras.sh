...
echo ""
echo "Setup Order:"
echo "  Camera 1 (North) - Define: north_entry, north_exit, north_circulating"
echo "  Camera 2 (East)  - Define: east_entry, east_exit, east_circulating"
echo "  Camera 3 (South) - Define: south_entry, south_exit, south_circulating"
echo "  Camera 4 (West)  - Define: west_entry, west_exit, west_circulating"
echo ""
echo "Zone Colors:"
echo "  - Entry (Green): Vehicles entering from the approach"
echo "  - Exit (Red): Vehicles exiting to the approach"
echo "  - Circulating (Blue): Vehicles circulating in the roundabout"
echo ""
echo "================================================================"
echo ""
